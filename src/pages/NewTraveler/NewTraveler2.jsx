  ...
  return (
    ...
    <div className="new__traveler_content">
      ...
      <div className="req__inputs_list">
          ...
          <div className="req__input_label" htmlFor="">NAME<span>*</span></div>
      </div>
      ...
      <div className="req__inputs_list">
        ...
        <div>
          <input className="req__input" id="birth" type="text" placeholder="04/02/2022" />
          <div className="req__input_label" htmlFor="birth">DATE OF BIRTH</div>
        </div>
