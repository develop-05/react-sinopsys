...
export const Travelers2 = () => {
  ...
  return (
    <>
      <div className="detail__item traveler__item_block">
      ...
      >
        <div className={isVisible ? "all__details_visible" : "all__details"}>
          ...
          <div className="new__travelers">
            <Link to="">
              <div className="flight__btn max__width_req">Add Corporate Travelers</div>
            </Link>

            <Link to="/new-traveler2">
              <div className="flight__btn max__width_req mt-30">Add Guest</div>
            </Link>
          </div>
